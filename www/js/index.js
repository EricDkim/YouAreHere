...
$("#select-building").change(function() {
    ...
    // };
    // var map = new google.maps.Maps(document.getElementById('googleMap'), mapOptions);
  ...
  var cordovaExample = { // cordovaExample for H building
  watchId : null,
  regionWatchId : null,
  marker : null,
  retina : window.devicePixelRatio > 1 ? true : false,
  ...
  initializeMap: function() {
    ...
    var mapProp = {
      center: new google.maps.LatLng(33.980189062734794, -84.00379836559297),
      //center: new google.maps.LatLng(65.060848804763, 25.4410770535469),
      zoom: 18,
      mapTypeId: google.maps.MapTypeId.ROADMAP,
      mapTypeControl: false,
